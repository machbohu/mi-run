...
public final class VMDoubleCompMinus extends VMBinaryDoubleCompOperator {

	public VMDoubleCompMinus(double opOne, VMOperator opTwo) {
		super(opOne, opTwo);
	}

	public VMDoubleCompMinus(VMOperator opOne, double opTwo) {
		super(opOne, opTwo);
	}
