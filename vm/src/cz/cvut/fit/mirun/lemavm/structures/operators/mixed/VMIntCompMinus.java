...
public final class VMIntCompMinus extends VMBinaryIntCompOperator {

	public VMIntCompMinus(int opOne, VMOperator operTwo) {
		super(opOne, operTwo);
	}

	public VMIntCompMinus(VMOperator operOne, int opTwo) {
		super(operOne, opTwo);
	}
