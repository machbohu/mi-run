...
public final class VMShortCompMinus extends VMBinaryShortCompOperator {

	public VMShortCompMinus(short opOne, VMOperator operTwo) {
		super(opOne, operTwo);
	}

	public VMShortCompMinus(VMOperator operOne, short opTwo) {
		super(operOne, opTwo);
	}
