...
public final class VMLongCompMultiply extends VMBinaryLongCompOperator {

	public VMLongCompMultiply(long opOne, VMOperator operTwo) {
		super(opOne, operTwo);
	}

	public VMLongCompMultiply(VMOperator operOne, long opTwo) {
		super(operOne, opTwo);
	}
