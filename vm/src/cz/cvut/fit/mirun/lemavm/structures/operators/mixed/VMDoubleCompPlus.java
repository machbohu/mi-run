...
public final class VMDoubleCompPlus extends VMBinaryDoubleCompOperator {

	public VMDoubleCompPlus(double opOne, VMOperator opTwo) {
		super(opOne, opTwo);
	}

	public VMDoubleCompPlus(VMOperator opOne, double opTwo) {
		super(opOne, opTwo);
	}
