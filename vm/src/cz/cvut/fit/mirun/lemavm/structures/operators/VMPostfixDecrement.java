...
public final class VMPostfixDecrement extends VMUnaryOperator {

	public VMPostfixDecrement(VMObject operand) {
		super(operand);
	}
	...
	protected VMObject evaulateImpl(VMObject op) {
		if (LOG.isTraceEnabled()) {
			LOG.trace("PostfixDecrement evaluating: " + op);
		}
		if (!(op instanceof VMNumber)) {
			throw new VMEvaluationException(
					"PostfixDecrement is not applicable for operand of type "
							+ op.getType());
		}
