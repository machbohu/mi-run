...
public final class VMUnaryPlus extends VMUnaryOperator {

	public VMUnaryPlus(VMObject operand) {
		super(operand);
	}
	...
	protected VMObject evaulateImpl(VMObject op) {
		if (LOG.isTraceEnabled()) {
			LOG.trace("UnaryPlus evaluating: " + op);
		}
		if (!(op instanceof VMNumber)) {
			throw new VMEvaluationException(
					"UnaryPlus is not applicable for operand of type "
							+ op.getType());
		}
