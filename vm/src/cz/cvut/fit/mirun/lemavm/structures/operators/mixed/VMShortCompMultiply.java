...
public final class VMShortCompMultiply extends VMBinaryShortCompOperator {

	public VMShortCompMultiply(short opOne, VMOperator operTwo) {
		super(opOne, operTwo);
	}

	public VMShortCompMultiply(VMOperator operOne, short opTwo) {
		super(operOne, opTwo);
	}
