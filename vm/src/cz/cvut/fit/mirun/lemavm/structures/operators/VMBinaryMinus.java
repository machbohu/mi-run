...
public final class VMBinaryMinus extends VMBinaryOperator {

	public VMBinaryMinus(VMObject operandOne, VMObject operandTwo) {
	...
	protected VMObject evaluateImpl(VMObject opOne, VMObject opTwo) {
		if (LOG.isTraceEnabled()) {
			LOG.trace("BinaryMinus evaluating: " + opOne + " - " + opTwo);
		}
		...
		if (opOne instanceof VMNumber && opTwo instanceof VMNumber) {
			...
			throw new VMEvaluationException(
					"BinaryMinus is not applicable for operands of type "
