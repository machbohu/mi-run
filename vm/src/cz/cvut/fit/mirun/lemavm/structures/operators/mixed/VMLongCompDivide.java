...
public final class VMLongCompDivide extends VMBinaryLongCompOperator {

	public VMLongCompDivide(long opOne, VMOperator operTwo) {
		super(opOne, operTwo);
	}

	public VMLongCompDivide(VMOperator operOne, long opTwo) {
		super(operOne, opTwo);
	}
