...
public class LeMaVMLexer extends Lexer {
	 ...
	 * the hidden channel, otherwise the appropriate tokens will be skiped. This
	 * is a 'little bit' expensive, of course. If only one of the two behaviours
	 * is needed forever the lexer part of the grammar should be changed by
	 * replacing the 'if-else' stuff within the approprate lexer grammar
	 * actions.
	 */
	...
	public final void mHEX_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// LeMaVM.g:812:13: ( '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ (
			// INTEGER_TYPE_SUFFIX )? )
			// LeMaVM.g:812:15: '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ (
			// INTEGER_TYPE_SUFFIX )?
			{
				match('0');
	...
	public final void mFLOATING_POINT_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// LeMaVM.g:825:5: ( ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* (
			// EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX
			// )? | FLOAT_TYPE_SUFFIX ) | DOT ( '0' .. '9' )+ ( EXPONENT )? (
			// FLOAT_TYPE_SUFFIX )? )
			int alt17 = 2;
			...
			switch (alt17) {
			case 1:
			// LeMaVM.g:825:9: ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT
			// )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? |
			// FLOAT_TYPE_SUFFIX )
			{
				// LeMaVM.g:825:9: ( '0' .. '9' )+
				int cnt8 = 0;
				...
				// LeMaVM.g:826:9: ( DOT ( '0' .. '9' )* ( EXPONENT )? (
				// FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? |
				// FLOAT_TYPE_SUFFIX )
				int alt13 = 3;
				switch (input.LA(1)) {
				...
				switch (alt13) {
				case 1:
				// LeMaVM.g:827:13: DOT ( '0' .. '9' )* ( EXPONENT )? (
				// FLOAT_TYPE_SUFFIX )?
				{
					mDOT();
					// LeMaVM.g:827:17: ( '0' .. '9' )*
				...
				break;
			case 2:
			// LeMaVM.g:831:9: DOT ( '0' .. '9' )+ ( EXPONENT )? (
			// FLOAT_TYPE_SUFFIX )?
			{
				mDOT();
				// LeMaVM.g:831:13: ( '0' .. '9' )+
	...
	public final void mUNICODE_ESCAPE() throws RecognitionException {
		try {
			// LeMaVM.g:864:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT
			// HEX_DIGIT )
			// LeMaVM.g:864:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT
			// HEX_DIGIT
			{
				match('\\');
				match('u');
	...
	public void mTokens() throws RecognitionException {
		// LeMaVM.g:1:8: ( AND | AND_ASSIGN | ASSIGN | AT | BIT_SHIFT_RIGHT |
		// BIT_SHIFT_RIGHT_ASSIGN | COLON | COMMA | DEC | DIV | DIV_ASSIGN | DOT
		// | DOTSTAR | ELLIPSIS | EQUAL | GREATER_OR_EQUAL | GREATER_THAN | INC
		// | LBRACK | LCURLY | LESS_OR_EQUAL | LESS_THAN | LOGICAL_AND |
		// LOGICAL_NOT | LOGICAL_OR | LPAREN | MINUS | MINUS_ASSIGN | MOD |
		// MOD_ASSIGN | NOT | NOT_EQUAL | OR | OR_ASSIGN | PLUS | PLUS_ASSIGN |
		// QUESTION | RBRACK | RCURLY | RPAREN | SEMI | SHIFT_LEFT |
		// SHIFT_LEFT_ASSIGN | SHIFT_RIGHT | SHIFT_RIGHT_ASSIGN | STAR |
		// STAR_ASSIGN | XOR | XOR_ASSIGN | BOOLEAN | BREAK | CASE | CLASS |
		// CONTINUE | DEFAULT | DO | DOUBLE | ELSE | EXTENDS | FALSE | FINAL |
		// FOR | IF | INSTANCEOF | IMPORT | INT | LONG | NEW | NULL | PACKAGE |
		// PRIVATE | PROTECTED | PUBLIC | RETURN | SHORT | STATIC | SUPER |
		// SWITCH | THIS | TRUE | TRY | VOID | WHILE | HEX_LITERAL |
		// DECIMAL_LITERAL | OCTAL_LITERAL | FLOATING_POINT_LITERAL |
		// CHARACTER_LITERAL | STRING_LITERAL | IDENT | WS | COMMENT |
		// LINE_COMMENT )
		int alt28 = 93;
	...
	static final String DFA28_eotS = "\1\uffff\1\60\1\62\1\uffff\1\65\2\uffff\1\70\1\74\1\77\1\103\2\uffff"
	...
	static final String DFA28_eofS = "\u010b\uffff";
	static final String DFA28_minS = "\1\11\1\46\1\75\1\uffff\1\75\2\uffff\1\55\2\52\1\53\2\uffff\1\74"
			...
			+ "\2\44\2\uffff";
	static final String DFA28_maxS = "\1\ufaff\2\75\1\uffff\1\76\2\uffff\2\75\1\71\1\75\2\uffff\2\75\1"
			...
			+ "\1\144\1\uffff\1\146\2\ufaff\2\uffff";
	static final String DFA28_acceptS = "\3\uffff\1\4\1\uffff\1\7\1\10\4\uffff\1\23\1\24\3\uffff\1\32\1\uffff"
	...
	static final String DFA28_specialS = "\u010b\uffff}>";
