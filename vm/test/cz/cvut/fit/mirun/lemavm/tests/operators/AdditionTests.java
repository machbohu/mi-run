...
public class AdditionTests {
	...
	public void testAddHierarchical() {
		...
		final short res = op.evaluateShort();
		assertEquals(exp, res);
	}
	...
	public void testAddWithMixedTypes() {
		...
		final VMOperator op = factory.createOperator(
				...
				104L);
		final double res = op.evaluateDouble();
	...
	public void testAddWithZero() {
		...
		final long res = op.evaluateLong();
		assertEquals(exp, res);
	}
	...
	public void testAddNull() {
		...
		final VMOperator op = factory.createOperator(0.8, null);
